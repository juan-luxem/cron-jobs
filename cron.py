...
# from generacion_ofertada import generacion_ofertada_mda, generacion_ofertada_mtr_expost
# from generacion_hidro_ofertada import generacion_hidro_ofertada_diaria_mda, generacion_hidro_ofertada_diaria_mtr_expot
...
if __name__ == "__main__":
    ...
    ## Cron para ofertas MDA y MTR Expost
    # scheduler.add_job(
    #     generacion_hidro_ofertada_diaria_mda.obtener_generacion_hidro_ofertada_diaria_mda,
    #     "cron",
    #     day_of_week="*", # every day
    #     hour="6", # Every day at 6 AM
    #     minute="0" # Every day at 6:00 AM
    # )

    # scheduler.add_job(
    #     generacion_hidro_ofertada_diaria_mtr_expot.obtener_generacion_hidro_ofertada_diaria_mtr,
    #     "cron",
    #     day_of_week="*", # every day
    #     hour="6", # Every day at 6 AM
    #     minute="5" # Every day at 6:05 AM
    # )

    # scheduler.add_job(
    #     generacion_ofertada_mda.obtener_generacion_ofertada_mda,
    #     "cron",
    #     day_of_week="*", # every day
    #     hour="6", # Every day at 6 AM
    #     minute="15" # Every day at 6:15 AM
    # )

    # scheduler.add_job(
    #     generacion_ofertada_mtr_expost.obtener_generacion_ofertada_mtr_expost,
    #     "cron",
    #     day_of_week="*", # every day
    #     hour="6", # Every day at 6 AM
    #     minute="30" # Every day at 6:30 AM
    # )
