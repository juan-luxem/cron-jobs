...
from generacion_ndso_ofertada.constants import (
    URL,
    ID_REPORT,
    MIN_DATE,
    VIEW_GENERATOR,
...
def get_generacion_ndso_ofertada(market_type: str):
    """
    Generic function to download Ofertas No Despachables data
