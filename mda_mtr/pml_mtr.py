...
API_TARGET_SOURCE_PMLMTR = "pml_mtr"
...
def get_pml_mtr():
    ...
    for sistema in SISTEMAS:
        ...
        if response.status_code == 200:
            ...
            if "attachment" in content_disposition and ".zip" in content_disposition:
                ...
                new_filename = f"PML_MTR_{sistema}.csv"
    ...
    try:
        ...
        if all_different:
            ...
            date_sin = extract_date("PML_MTR_SIN.csv")
            date_bca = extract_date("PML_MTR_BCA.csv")
            date_bcs = extract_date("PML_MTR_BCS.csv")
